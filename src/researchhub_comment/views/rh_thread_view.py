...
class RhThreadViewSet(ModelViewSet):
    queryset = RhCommentModel.objects.filter()
    serializer_class = RhThreadSerializer
    permission_classes = [
        # IsAuthenticatedOrReadOnly,
    ...
    def create_comment(self, request, pk=None):
        try:
            ...
            RhCommentModel.create_from_request(request, rh_thread)
    ...
    def _retrieve_or_create_thread_from_request(self):
        try:
            ...
            if thread_id:
                ...
                existing_thread = RhThreadSerializer._get_existing_thread_from_request(
                    request
                )
