...
class AIPeerReviewPermission(AuthorizationBasedPermission):
    ...
    Object-level: proposal review visibility (author, grant owner, entitlement, editors)
    or grant comparison visibility (must override here because AuthorizationBasedPermission
    treats all safe methods as allowed on objects).
    """
