...
BulletPointFlagged = Distribution("BULLET_POINT_FLAGGED", -2, True, -2)
BulletPointUpvoted = Distribution("BULLET_POINT_UPVOTED", 1)
BulletPointDownvoted = Distribution("BULLET_POINT_DOWNVOTED", -1, True, -1)

CommentCensored = Distribution("COMMENT_CENSORED", -2, True, -2)
CommentFlagged = Distribution("COMMENT_FLAGGED", -2, True, -2)
CommentUpvoted = Distribution("COMMENT_UPVOTED", 1)
CommentDownvoted = Distribution("COMMENT_DOWNVOTED", -1, True, -1)

ReplyCensored = Distribution("REPLY_CENSORED", -2, True, -2)
ReplyFlagged = Distribution("REPLY_FLAGGED", -2, True, -2)
ReplyUpvoted = Distribution("REPLY_UPVOTED", 1)
ReplyDownvoted = Distribution("REPLY_DOWNVOTED", -1, True, -1)

ThreadCensored = Distribution("THREAD_CENSORED", -2, True, -2)
...
SummaryApproved = Distribution("SUMMARY_APPROVED", 15, True, 15)
SummaryRejected = Distribution("SUMMARY_REJECTED", -2, True, -2)
SummaryFlagged = Distribution("SUMMARY_FLAGGED", -5, True, -5)
SummaryUpvoted = Distribution("SUMMARY_UPVOTED", 1)
SummaryDownvoted = Distribution("SUMMARY_DOWNVOTED", -1, True, -1)
