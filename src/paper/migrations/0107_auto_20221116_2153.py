...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('CK_EDITOR', 'CK_EDITOR'), ('DRAFT_JS', 'DRAFT_JS'), ('TEXT_FIELD', 'TEXT_FIELD')], default='TEXT_FIELD', help_text='Indicates which text editor was used for abstract section.', max_length=32, null=True),
        ),
    ]
