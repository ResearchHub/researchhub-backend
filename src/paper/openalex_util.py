...
def process_openalex_works(works):
    ...
    process_openalex_authorships(paper_to_openalex_data, oa_authors_by_work_id)
...
def process_openalex_authorships(paper_to_openalex_data, oa_authors_by_work_id):
    """
