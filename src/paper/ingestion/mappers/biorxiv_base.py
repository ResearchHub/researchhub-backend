"""
BioRxiv/MedRxiv base data mapper for transforming API responses to Paper model format.

Maps BioRxiv/MedRxiv paper records to ResearchHub Paper model fields.
Both repositories share the same API structure and data format.
"""
...
class BioRxivBaseMapper(BaseMapper):
    """Base mapper for BioRxiv and MedRxiv paper records."""
    ...
    def validate(self, record: Dict[str, Any]) -> bool:
        ...
        """
        # Required fields from BioRxiv/MedRxiv API
    ...
    def map_to_paper(self, record: Dict[str, Any]) -> Paper:
        ...
        Args:
            record: BioRxiv/MedRxiv paper record
        ...
        paper = Paper(
            ...
            is_open_access=True,  # BioRxiv/MedRxiv are open access
        ...
        if doi and version:
            paper.pdf_url = self._compute_pdf_url(doi, version, server)
            paper.url = self._compute_html_url(doi, version, server)
    ...
    def _parse_license(self, license_str: Optional[str]) -> Optional[str]:
        ...
        Args:
            license_str: License string from BioRxiv/MedRxiv
    ...
    def _extract_authors(self, authors_str: str) -> List[Dict[str, Any]]:
        ...
        BioRxiv/MedRxiv returns authors as a semicolon-separated string.

        Args:
            authors_str: Author string from BioRxiv/MedRxiv
    ...
    def _parse_author_name(self, full_name: str) -> Dict[str, str]:
        ...
        BioRxiv/MedRxiv format is typically "Last Name, First Name"
    ...
    def _compute_pdf_url(self, doi: str, version: str, server: str) -> str:
        """
    ...
    def _compute_html_url(self, doi: str, version: str, server: str) -> str:
        """
    ...
    def map_to_authors(self, record: Dict[str, Any]) -> List[Author]:
        ...
        Note: BioRxiv/MedRxiv doesn't provide ORCID IDs, so we return empty list
    ...
    def map_to_institutions(self, record: Dict[str, Any]) -> List[Institution]:
        ...
        Note: BioRxiv/MedRxiv doesn't provide ROR IDs for institutions,
    ...
    def map_to_authorships(
        ...
        Note: BioRxiv/MedRxiv doesn't provide ORCID IDs for authors,
