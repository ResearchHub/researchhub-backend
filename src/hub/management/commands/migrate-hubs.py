...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.migrate_content('statistics theory', 'data analysis, statistics and probability')
        self.migrate_content('other statistics', 'data analysis, statistics and probability')
        ...
        self.migrate_content('earth and planetary astrophysics', 'astrophysics')
        self.migrate_content('cosmology and nongalactic astrophysics', 'astrophysics')
        ...
        self.migrate_content('computation and language', 'programming languages')
        self.migrate_content('human computer interaction', 'human-computer interaction')
        ...
        self.migrate_content('scientific-communication-and-education', 'metascience')
