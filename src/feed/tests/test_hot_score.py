...
class TestHotScore(TestCase):
    ...
    def test_comment_hot_score(self):
        """Test hot score calculation for comments."""
        # Calculate score for a comment
        score = calculate_hot_score_for_item(self.paper_comment)

        # Verify score is reasonable
        self.assertGreater(score, 0)

    def test_unknown_content_type_defaults_to_paper(self):
        """Test that unknown content types default to paper weights."""
        # Calculate with paper type
        paper_score = calculate_hot_score(self.paper, "paper")

        # Calculate with a fake type - should use paper weights as fallback
        unknown_score = calculate_hot_score(self.paper, "unknown_type")
    ...
    def test_minimum_score(self):
        ...
        score = calculate_hot_score_for_item(old_paper)
    ...
    def test_bounty_calculation(self):
        ...
        score_with_bounties = calculate_hot_score_for_item(self.paper)
        ...
        score_no_bounties = calculate_hot_score_for_item(paper_no_bounties)
    ...
    def test_peer_review_above_paper(self):
        ...
        paper_score = calculate_hot_score_for_item(self.paper)
        ...
        peer_review_score = calculate_hot_score_for_item(self.paper_review)
        ...
        regular_comment_score = calculate_hot_score_for_item(self.paper_comment)
