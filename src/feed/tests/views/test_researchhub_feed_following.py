...
class FollowingFeedTests(APITestCase):
    ...
    def test_authenticated_user_gets_followed_author_results(self):
        ...
        author_paper_doc.hubs.add(self.unfollowed_hub)
        ...
        author_paper_entry.hubs.add(self.unfollowed_hub)
    ...
    def test_user_follows_only_author_gets_author_results(self):
        ...
        self.assertIn(author_paper.id, result_ids)
        self.assertNotIn(self.followed_paper.id, result_ids)
