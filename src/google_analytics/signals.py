...
@receiver(post_save, sender=DiscussionVote, dispatch_uid="send_discussion_vote_event")
@receiver(post_save, sender=PaperVote, dispatch_uid="send_paper_vote_event")
