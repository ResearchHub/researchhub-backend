...
from research_ai.constants import EmailTemplateType, OverallRating, ReviewStatus
...
class ProposalReview(DefaultModel):
    """
    AI 5-dimension review for a preregistration (proposal), optionally scoped to a Grant (RFP).
    """
