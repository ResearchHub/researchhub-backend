...
def send_outreach_email(
    ...
    """
    Email an expert their generated outreach message.

    Raises ExpertFinderOutreachDisabledError while outreach is switched off.
    Returns the SES message ID when SES recorded one.
    """
