        ...
        return tools + [
            Tool(
                ...
                description=(
                    ...
                    "is null at the end. Reuse earlier blocks when their "
                    "version_id matches this turn's system prompt and the "
                    "blocks remain in context. A successful read or edit "
                    "during this turn supersedes that prompt version. "
                    "Otherwise start at block 0 "
                    "without version_id. Pass the returned version_id on "
                    "continuation reads. If the note "
                ...
                input_schema={
                    ...
                    "properties": {
                        ...
                        "version_id": {
                            "type": "integer",
                            "description": (
                                "Version returned by the current note's read. "
            ...
            Tool(
                ...
                description=(
                    ...
                    "At the start of a turn, compare the current version_id "
                    "in the system prompt with your last read_note or edit_note "
                    "result. If it matches and the needed blocks remain in "
                    "context, reuse them; otherwise read from block 0 without "
                    "version_id. A successful read or edit during this turn "
                    "supersedes that prompt version. Pass the version_id "
                    "from your latest read_note or edit_note result as "
                    "expected_version_id; the edit is "
