        ...
        return [
            ...
            Tool(
                ...
                description=(
                    ...
                    "Always call read_note first and pass its version_id as "
                    "expected_version_id; the edit is rejected if the note "
                    "changed since. Send only the blocks you are changing -- "
    ...
    def _edit_note(self, input: dict) -> dict:
        ...
        try:
            with transaction.atomic():
                ...
                # the edit surface only ever rewrites `content`.
                document = dict(stored) if stored else {"type": "doc"}
