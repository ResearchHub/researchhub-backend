...
class AuthorClaimCaseViewSet(ModelViewSet):
    ...
    def validate_user_request_email(self, request, *args, **kwargs):
        try:
            ...
            invalidation_result = self.check_and_invalidate_case(
                target_case,
                request.user
            )
    ...
    def check_and_invalidate_case(self, target_case, current_user):
