...
class Summary(models.Model):
    ...
    paper = models.ForeignKey(
        "paper.Paper", related_name="summaries", on_delete=models.CASCADE
    )
    ...
    def is_first_paper_summary(self):
        if self.approved and (self.previous is None) and (self.paper is not None):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["summary", "created_by"], name="unique_summary_vote"
            )
        ]
