...
AWS_PERSONALIZE_TRACKING_ID = os.environ.get("AWS_PERSONALIZE_TRACKING_ID", "")
AWS_PERSONALIZE_CAMPAIGN_ARN = os.environ.get("AWS_PERSONALIZE_CAMPAIGN_ARN", "")
AWS_PERSONALIZE_SIMS_CAMPAIGN_ARN = os.environ.get(
    "AWS_PERSONALIZE_SIMS_CAMPAIGN_ARN", ""
)

# Amplitude Webhook Configuration
AMPLITUDE_WEBHOOK_SECRET = os.environ.get("AMPLITUDE_WEBHOOK_SECRET", "")
