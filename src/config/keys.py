...
SALT_KEY = os.environ.get("SALT_KEY", "development-salt-key")
...
ENDAOMENT_CLIENT_ID = os.environ.get("ENDAOMENT_CLIENT_ID", "")
ENDAOMENT_CLIENT_SECRET = os.environ.get("ENDAOMENT_CLIENT_SECRET", "")
ENDAOMENT_REDIRECT_URL = os.environ.get("ENDAOMENT_REDIRECT_URL", "")
ENDAOMENT_RH_FUND_ID_ETHEREUM = os.environ.get("ENDAOMENT_RH_FUND_ID_ETHEREUM", "")
ENDAOMENT_RH_FUND_ID_OPTIMISM = os.environ.get("ENDAOMENT_RH_FUND_ID_OPTIMISM", "")
ENDAOMENT_RH_FUND_ID_BASE = os.environ.get("ENDAOMENT_RH_FUND_ID_BASE", "")
