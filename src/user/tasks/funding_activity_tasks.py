...
_SOURCE_TYPE_MODEL = {
    ...
    FundingActivity.USD_FUNDRAISE_PAYOUT: UsdFundraiseContribution,
...
def create_funding_activity_task(source_type, source_id):
    ...
    Args:
        source_type: One of FundingActivity.FUNDRAISE_PAYOUT,
            USD_FUNDRAISE_PAYOUT, BOUNTY_PAYOUT, TIP_DOCUMENT, TIP_REVIEW, FEE.
        source_id: Primary key of the source object (Purchase,
            UsdFundraiseContribution, EscrowRecipients, or Distribution).
    """
    ...
    try:
        ...
        logger.exception(
            "create_funding_activity_task: failed for source_type=%s source_id=%s",
            source_type,
            source_id,
        )
        raise
