...
from ai_expert_finder.models import DocumentInvitedExpert
from ai_expert_finder.services.invited_experts_service import (
...
@receiver(
    post_save,
    sender=User,
    dispatch_uid="ai_expert_finder_document_invited_expert_on_user_created",
)
