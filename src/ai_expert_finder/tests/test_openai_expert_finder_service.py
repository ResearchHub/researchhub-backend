...
from ai_expert_finder.services.openai_expert_finder_service import (
...
class OpenAIExpertFinderServiceTests(TestCase):
    ...
    @patch("ai_expert_finder.services.openai_expert_finder_service.OpenAI")
    ...
    @override_settings(OPENAI_API_KEY="sk-test")
    @patch("ai_expert_finder.services.openai_expert_finder_service.sentry.log_error")
    @patch("ai_expert_finder.services.openai_expert_finder_service.OpenAI")
