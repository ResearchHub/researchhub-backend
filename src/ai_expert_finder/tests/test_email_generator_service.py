...
from ai_expert_finder.services.email_generator_service import (
...
class GenerateExpertEmailTests(TestCase):
    @patch("ai_expert_finder.services.email_generator_service.BedrockLLMService")
    @patch("ai_expert_finder.services.email_generator_service.build_email_prompt")
    ...
    @patch(
        "ai_expert_finder.services.email_generator_service.resolve_expert_search_email_document_context"
    )
    @patch("ai_expert_finder.services.email_generator_service.get_email_template")
