"""Tests for ai_expert_finder.services.rfp_email_context."""
...
from ai_expert_finder.services.rfp_email_context import (
    build_rfp_context,
...
class BuildRfpContextTests(TestCase):
    ...
    @patch("ai_expert_finder.services.rfp_email_context.get_grant_frontend_url")
...
class ResolveGrantTests(TestCase):
    ...
    @patch("ai_expert_finder.services.rfp_email_context.ExpertSearch")
