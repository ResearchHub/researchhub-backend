...
from ai_expert_finder.constants import ExpertiseLevel, Gender, Region
...
from ai_expert_finder.services.expert_finder_service import get_document_content
from ai_expert_finder.services.progress_service import ProgressService, TaskType
from ai_expert_finder.tasks import process_expert_search_task
...
def _get_sse_url(request, search_id):
    ...
    return base + "/api/ai_expert_finder/expert-finder/progress/" + search_id + "/"
