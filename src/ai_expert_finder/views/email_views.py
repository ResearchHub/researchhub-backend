...
from ai_expert_finder.constants import DEFAULT_EMAIL_TEMPLATE_KEY, VALID_EMAIL_TEMPLATE_KEYS
from ai_expert_finder.models import ExpertSearch, GeneratedEmail
...
from ai_expert_finder.services.email_generator_service import generate_expert_email
from ai_expert_finder.services.email_sending_service import send_plain_email
from ai_expert_finder.services.email_template_variables import format_expert_name_from_raw
from ai_expert_finder.services.rfp_email_context import resolve_expert_from_search
from ai_expert_finder.tasks import process_bulk_generate_emails_task, send_queued_emails_task
...
class GenerateEmailView(APIView):
    """POST /api/ai_expert_finder/expert-finder/generate-email/ - Generate outreach email via LLM and save as draft."""
...
class BulkGenerateEmailView(APIView):
    """POST /api/ai_expert_finder/expert-finder/generate-emails-bulk/ - Create placeholders and enqueue Celery task."""
...
class PreviewEmailView(APIView):
    """POST /api/ai_expert_finder/expert-finder/emails/preview/ - Send generated email(s) to current user."""
...
class SendEmailView(APIView):
    """POST /api/ai_expert_finder/expert-finder/emails/send/ - Send generated emails to experts via SES."""
...
class GeneratedEmailListView(APIView):
    """GET /api/ai_expert_finder/expert-finder/emails/ - List. POST - Create draft (no LLM)."""
...
class GeneratedEmailDetailView(APIView):
    """GET /api/ai_expert_finder/expert-finder/emails/<id>/ - Retrieve one. PATCH - Update. DELETE - Delete."""
