...
from ai_expert_finder.constants import VALID_EMAIL_TEMPLATE_KEYS
...
from ai_expert_finder.services.expert_finder_service import ExpertFinderService
...
@app.task(
    bind=True,
    name="ai_expert_finder.tasks.process_expert_search_task",
)
...
@app.task(
    bind=True,
    name="ai_expert_finder.tasks.process_bulk_generate_emails_task",
)
...
@app.task(
    bind=True,
    name="ai_expert_finder.tasks.send_queued_emails_task",
)
