...
from ai_expert_finder.constants import BASE_FRONTEND_URL, DEFAULT_EMAIL_TEMPLATE_KEY
from ai_expert_finder.prompts.email_prompts import build_email_prompt
from ai_expert_finder.services.bedrock_llm_service import BedrockLLMService
from ai_expert_finder.services.email_template_service import (
    get_template as get_email_template,
)
from ai_expert_finder.services.email_template_variables import (
    _build_user_context,
