...
from ai_expert_finder.constants import ExpertiseLevel, Region, get_choice_label
...
def upload_report_to_storage(
    ...
    """
    file_key = f"ai_expert_finder/expert-finder/{search_id}/report.{file_extension}"
